        ...
        <div class="card">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Form Add Role User</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form  method="POST" action="{{route('admin.product.addrole')}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="card-body">
                  <div class="form-group">
                        <label for="exampleInputEmail1">Role User</label>
                        <input type="text" class="form-control" id="role" placeholder="Masukan Role User" name="role" required>
                  </div>
                </div>
                <!-- /.card-body -->
